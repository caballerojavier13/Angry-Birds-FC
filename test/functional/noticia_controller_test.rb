...
class NoticiaControllerTest < ActionController::TestCase
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post :create, noticium: { cuerpo: @noticium.cuerpo, imagen_id: @noticium.imagen_id, persona_id: @noticium.persona_id, titulo: @noticium.titulo, updated_at: @noticium.updated_at }
    end
  ...
  test "should update noticium" do
    put :update, id: @noticium, noticium: { cuerpo: @noticium.cuerpo, imagen_id: @noticium.imagen_id, persona_id: @noticium.persona_id, titulo: @noticium.titulo, updated_at: @noticium.updated_at }
    assert_redirected_to noticium_path(assigns(:noticium))
  end
